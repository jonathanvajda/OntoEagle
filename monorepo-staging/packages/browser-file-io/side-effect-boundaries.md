...
|BOUND-006|BFI-002 `getAcceptExtensions`|Pure core currently in browser helper file|Pure core|None|Format descriptors|String return|No|Yes|Yes|May belong in format-registry or browser-file-io depending final package split.|
...
|:---|:---|:---|:---|:---|:---|
|REF-001|Promoted download helper currently lives under `format-registry`|Move to `packages/browser-file-io/src/download-text-file.js` and re-export from app shared package copies|BFI-001 and all wrappers|Mock `Blob`, `URL.createObjectURL`, anchor append/click/remove, MIME/charset behavior|Keep import path migration simple; avoid browser globals.|
